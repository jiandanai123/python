...
import os
#方案一
    # casepath = "D:\\Python\\unnitest\\case"
    ...
    # # runner.run(discover)
    #
    # reportpath = "D:\\Python\\unnitest\\report\\"+"result.html"
    #
    # fp = open(reportpath,"wb")
    # runner = HTMLTestRunner_api.HTMLTestRunner(fp, verbosity=2, title="测试报告", description="报告描述")
    # runner.run(discover)
    # fp.close()
